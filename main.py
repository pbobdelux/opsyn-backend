...
from routes.mobile_api import router as mobile_api_router  # noqa: E402
...
# Mobile API — lightweight iOS-facing endpoints (/api/mobile/...)
# Router owns its full prefix; do NOT add a prefix here.
