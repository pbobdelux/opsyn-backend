...
router = APIRouter(prefix="/organizations", tags=["drivers"])
...
@router.post("/{org_id}/drivers", status_code=201)
...
@router.get("/{org_id}/drivers", status_code=200)
...
@router.get("/{org_id}/drivers/{driver_id}", status_code=200)
...
@router.patch("/{org_id}/drivers/{driver_id}", status_code=200)
